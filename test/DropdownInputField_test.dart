...
void main() {
  ...
  testWidgets('DropdownInputField displays options correctly with filter', (WidgetTester tester) async {
    String? selectedOption;
    // Build our app and trigger a frame.
    await tester.pumpWidget(
      MaterialApp(
    ...
    await tester.enterText(find.byType(TextFormField), 'Option1');
    await tester.pump();
    expect(find.text('Option1 '), findsOneWidget);
    expect(find.text('Option2 '), findsNothing);
